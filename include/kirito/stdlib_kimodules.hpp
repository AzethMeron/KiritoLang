...
// --- pandas: labelled Series/DataFrame with CSV I/O, indexing, aggregation, group-by, joins ---
inline constexpr std::string_view pandas = R"KI(
# A pandas-like data-analysis library in pure Kirito: labelled 1-D `Series` and 2-D `DataFrame`,
...
class Series:
    ...
    var count = Function(self) -> Integer:
        return len(_numeric(self.values))

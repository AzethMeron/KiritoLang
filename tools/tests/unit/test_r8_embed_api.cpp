...
//   8. Parse/nesting depth guard raises a catchable KiritoError (never crashes the host) for pathological
//      bracket- and paren-nesting; and the call-depth guard (setMaxCallDepth) raises on deep recursion.
...
int main() {
    ...
    // ============================================================================================
    {
        ...
        // get on a real Dict with an absent key (no default) raises; with a default does not.
    ...
    // ============================================================================================
    {
        ...
        CHECK_THROWS(vm.runSource("Vec3(1, 2, 3)[7]"));   // out-of-range index raises (catchable)
    ...
    // ============================================================================================
    // 8) Parse/nesting + call-depth guards raise a catchable KiritoError (never crash the host).
    // ============================================================================================
    {
        KiritoVM vm;
        ...
        // The call-depth guard raises a catchable "maximum recursion depth exceeded" (no native overflow).
        KiritoVM rvm;

...
int main() {
    ...
    // ============================================================================================
    {
        ...
        // a zero step raises (sliceIndices contract), surfaced cleanly.
    ...
    // ============================================================================================
    {
        ...
        // wrong arity / out of range raise (and are catchable).
    ...
    // ============================================================================================
    {
        ...
        // iterate() throws in C++ -> a `for` over a Grid raises, catchable from Kirito.

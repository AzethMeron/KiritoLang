# Lesson 14 — Classes II: Operators and Protocols

In Lesson 13 your classes had named methods. Now you'll make them feel like *built-in* types — usable
...
- `_call_` makes instances callable.
